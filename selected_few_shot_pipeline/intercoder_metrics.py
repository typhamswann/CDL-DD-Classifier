...
# Load CSV file
csv_file = 'selected_few_shot_pipeline/new_data_results.csv'  # Update with your CSV file path
data = pd.read_csv(csv_file)

# Assuming your CSV has columns 'Coder1', 'Coder2', 'Coder3'
coders = ['ty_label', 'will_label', 'llm_label']
